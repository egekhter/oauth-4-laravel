...
class OAuth
{
     ...
     */
    public function consumer( $service, $url = null, $scope = null, $version = null )
    {
        // get config
        ...
        return $this->_serviceFactory->createService($service, $credentials, $storage, $scope, null, $version);
